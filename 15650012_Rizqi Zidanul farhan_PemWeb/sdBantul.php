					...
					<section id="one">
						...
						<div class="row"></div>
							...
							<tbody>
								...
								{
									$jumlah_sekolah=mysql_num_rows(mysql_query("SELECT * FROM sd WHERE kabupaten='Kab. Bantul'"));
									$siswa  = $row['siswa'] == 0 ? '' : number_format($row['siswa'], 0, ',', '.');
									$query = "SELECT * FROM sd WHERE kabupaten='Kab. Bantul'"; 	 
							...
							<tfoot>
								...
								<tr>
									<th colspan="11">Jumlah sekolah</th>
									<th><?=number_format($jumlah_sekolah, 0, ',', '.')?></th>
								</tr>
							</tfoot>
						</table>
						</section>
